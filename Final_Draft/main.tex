...
%   table notes.
%
% FIGURES: see FIGURES_SPEC.md.  Four figures already exist in figures/;
%   the remaining ones are specified there and are commented out below
...
% This report carries 33 tables and 5 figures.  LaTeX holds at most 18 unprocessed
...
\begin{figure}[!t]
\centering
% Replace the placeholder box below with the line above once the flowchart is drawn.
% \includegraphics[width=0.92\linewidth]{figures/fig_flowchart.pdf}
\framebox[0.92\linewidth]{%
  \parbox[c][5.5cm][c]{0.85\linewidth}{\centering
  \textsc{[Fig.~1 placeholder --- system flowchart.}\\[2pt]
  \textsc{Content, layout and caption are specified in} \texttt{FIGURES\_SPEC.md}, \textsc{item F1.]}}}
\caption{Flowchart of the complete proposed system. Raw ICBHI recordings and
their cycle annotations enter at the left; the audited split loader and the
...
every score in Section~\ref{sec:results} is recomputable.}
\label{fig:flowchart}
\end{figure}
